...
public class Preferences {
  ...
  public static native void Changes(
      Context con, int fNum, String fName, int i, boolean bool, String str);
  ...
  public static void changeFeatureColor(
      String featureName, int featureNum, int alpha, int red, int green, int blue) {
    Preferences.with(context).writeInt(featureNum, alpha);
    // Changes(context, featureNum, featureName, 0, false, null, alpha, red, green, blue);
  }
